...
class BibleSearchList extends StatelessWidget {
  ...
  const BibleSearchList(this.query, {super.key});

  @override
  Widget build(BuildContext context) {
    return StoreConnector<AppState, _BibleSearchViewModel>(
...
class _BibleSearchListWidgetState extends State<_BibleSearchListWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    if (bibles.isEmpty && verses.isEmpty) {
      return const MessageLoading(message: "검색 결과가 없습니다.");
    }
